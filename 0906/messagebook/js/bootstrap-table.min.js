...
(function (e, t) {
    ...
    (function (n) {
        var s = 3;
        try {
            var u = n.fn.dropdown.Constructor.VERSION;
            u !== void 0 && (s = parseInt(u, 10))
        } catch (t) {}
        var l = {
                3: {
                        ...
                        try {
                            for (var g, f = e[v][Symbol.iterator](); !(c = (g = f.next()).done); c = !0) {
                                var b = g.value,
                                    ...
                                    m = b.colspan || 1,
                                    w = o[v].indexOf(!1);
                                1 === m && (b.fieldIndex = w, 'undefined' == typeof b.field && (b.field = w));
                                for (var x = 0; x < r; x++) o[v + x][w] = !0;
                                for (var k = 0; k < m; k++) o[v][w + k] = !0
                            }
                        } catch (e) {
                            h = !0, u = e
                        } finally {
            ...
            return o(t, [{
                ...
                value: function () {
                    if (this.options.locale) {
                        ...
                        t[0].toLowerCase(), t[1] && t[1].toUpperCase(), e[this.options.locale] ? n.extend(this.options, e[this.options.locale]) : n.fn.bootstrapTable.locales[t.join('-')] ? n.extend(this.options, e[t.join('-')]) : n.fn.bootstrapTable.locales[t[0]] && n.extend(this.options, e[t[0]])
                    }
                }
            }, {
                key: 'initContainer',
                ...
                value: function () {
                    var e = this,
                        o = [],
                        i = [];
                    if (this.$header = this.$el.find('>thead'), this.$header.length || (this.$header = n('<thead class="' + this.options.theadClasses + '"></thead>').appendTo(this.$el)), this.$header.find('tr').each(function (e, t) {
                            var a = [];
                        ...
                        this.$el.find('>tbody>tr').each(function (t, o) {
                            ...
                            s._id = n(o).attr('id'), s._class = n(o).attr('class'), s._data = r.getRealDataAttr(n(o).data()), n(o).find('>td').each(function (o, i) {
                                ...
                                s[c] = n(i).html(), s['_' + c + '_id'] = n(i).attr('id'), s['_' + c + '_class'] = n(i).attr('class'), s['_' + c + '_rowspan'] = n(i).attr('rowspan'), s['_' + c + '_colspan'] = n(i).attr('colspan'), s['_' + c + '_title'] = n(i).attr('title'), s['_' + c + '_data'] = r.getRealDataAttr(n(i).data())
                            }), i.push(s)
                ...
                value: function () {
                    var e = this,
                        ...
                        a = 0;
                    return this.options.customSort === n.noop ? void(-1 !== i && (this.options.sortStable && this.data.forEach(function (e, t) {
                        e._position = t
                        ...
                        return void 0 === p ? ((void 0 === l || null === l) && (l = ''), (void 0 === d || null === d) && (d = ''), e.options.sortStable && l === d) ? (l = s._position, d = a._position, s._position - a._position) : n.isNumeric(l) && n.isNumeric(d) ? (l = parseFloat(l), d = parseFloat(d), l < d ? -1 * o : o) : l === d ? 0 : ('string' != typeof l && (l = l.toString()), -1 === l.localeCompare(d) ? -1 * o : o) : e.options.sortStable && 0 === p ? s._position - a._position : o * p
                    }), void 0 !== this.options.sortClass && (clearTimeout(a), a = setTimeout(function () {
                        e.$el.removeClass(e.options.sortClass);
                        var t = e.$header.find(r.sprintf('[data-field="%s"]', e.options.sortName).index() + 1);
                        e.$el.find(r.sprintf('tr td:nth-child(%s)', t)).addClass(e.options.sortClass)
                    }, 250)))) : void this.options.customSort.apply(this, [this.options.sortName, this.options.sortOrder])
                }
            }, {
                key: 'onSort',
                value: function (e) {
                ...
                value: function () {
                    ...
                    if ('server' !== this.options.sidePagination) {
                        if (this.options.customSearch !== n.noop) return void r.calculateObjectValue(this.options, this.options.customSearch, [this.searchText]);
                        ...
                        this.data = o ? this.options.data.filter(function (e) {
                            ...
                            for (var c = 0; c < e.header.fields.length; c++)
                                if (e.header.searchables[c]) {
                                    ...
                                    if (s && s.searchFormatter && (l = r.calculateObjectValue(s, e.header.formatters[c], [l, o, a], l)), 'string' == typeof l || 'number' == typeof l)
                                        if (e.options.strictSearch) {
                                            if (('' + l).toLowerCase() === t) return !0;
                                        } else if (('' + l).toLowerCase().includes(t)) return !0
                                } return !1
                        }) : this.data
                    }
                }
                ...
                value: function () {
                    ...
                    if ('server' !== this.options.sidePagination && (this.options.totalRows = u.length), this.totalPages = 0, this.options.totalRows) {
                        if (this.options.pageSize === this.options.formatAllRows()) this.options.pageSize = this.options.totalRows, o = !0;
                        else if (this.options.pageSize === this.options.totalRows) {
                            var v = 'string' == typeof this.options.pageList ? this.options.pageList.replace('[', '').replace(']', '').replace(/ /g, '').toLowerCase().split(',') : this.options.pageList;
                            v.includes(this.options.formatAllRows().toLowerCase()) && (o = !0)
                        }
                        this.totalPages = ~~((this.options.totalRows - 1) / this.options.pageSize) + 1, this.options.totalPages = this.totalPages
                    }
                    if (0 < this.totalPages && this.options.pageNumber > this.totalPages && (this.options.pageNumber = this.totalPages), this.pageFrom = (this.options.pageNumber - 1) * this.options.pageSize + 1, this.pageTo = this.options.pageNumber * this.options.pageSize, this.pageTo > this.options.totalRows && (this.pageTo = this.options.totalRows), t.push(r.sprintf('<div class="%s-%s pagination-detail">', l.classes.pull, this.options.paginationDetailHAlign), '<span class="pagination-info">', this.options.onlyInfoPagination ? this.options.formatDetailPagination(this.options.totalRows) : this.options.formatShowingRows(this.pageFrom, this.pageTo, this.options.totalRows), '</span>'), !this.options.onlyInfoPagination) {
                        t.push('<span class="page-list">');
                        var x = [r.sprintf('<span class="btn-group %s">', 'top' === this.options.paginationVAlign || 'both' === this.options.paginationVAlign ? 'dropdown' : 'dropup'), '<button type="button" class="btn' + r.sprintf(' btn-%s', this.options.buttonsClass) + r.sprintf(' btn-%s', this.options.iconSize) + ' dropdown-toggle" data-toggle="dropdown">', '<span class="page-size">', o ? this.options.formatAllRows() : this.options.pageSize, '</span>', ' <span class="caret"></span>', '</button>', l.html.pageDropdown[0]];
                        if ('string' == typeof this.options.pageList) {
                            ...
                            var f = !0,
                                ...
                                m = void 0;
                            try {
                                for (var w, y, k = S[Symbol.iterator](); !(f = (w = k.next()).done); f = !0) y = w.value, g.push(y.toUpperCase() === this.options.formatAllRows().toUpperCase() || 'UNLIMITED' === y.toUpperCase() ? this.options.formatAllRows() : +y)
                            } catch (e) {
                                b = !0, m = e
                            } finally {
                                try {
                        ...
                        for (g.forEach(function (t, a) {
                                if (!e.options.smartDisplay || 0 === a || g[a - 1] < e.options.totalRows) {
                                    var i;
                                    i = o ? t === e.options.formatAllRows() ? 'active' : '' : t === e.options.pageSize ? 'active' : '', x.push(r.sprintf(l.html.pageDropdownItem, i, t))
                                }
                            }), x.push(l.html.pageDropdown[1] + '</span>'), t.push(this.options.formatRecordsPerPage(x.join(''))), t.push('</span>'), t.push('</div>', r.sprintf('<div class="%s-%s pagination">', l.classes.pull, this.options.paginationHAlign), '<ul class="pagination' + r.sprintf(' pagination-%s', this.options.iconSize) + '">', r.sprintf('<li class="page-item page-pre"><a class="page-link" href="#">%s</a></li>', this.options.paginationPreText)), 5 > this.totalPages ? (i = 1, s = this.totalPages) : (i = this.options.pageNumber - 2, s = i + 4, 1 > i && (i = 1, s = 5), s > this.totalPages && (s = this.totalPages, i = s - 4)), 6 <= this.totalPages && (3 <= this.options.pageNumber && (t.push(r.sprintf('<li class="page-item page-first%s">', 1 === this.options.pageNumber ? ' active' : ''), '<a class="page-link" href="#">', 1, '</a>', '</li>'), i++), 4 <= this.options.pageNumber && (4 === this.options.pageNumber || 6 === this.totalPages || 7 === this.totalPages ? i-- : t.push('<li class="page-item page-first-separator disabled">', '<a class="page-link" href="#">...</a>', '</li>'), s--)), 7 <= this.totalPages && this.options.pageNumber >= this.totalPages - 2 && i--, 6 === this.totalPages ? this.options.pageNumber >= this.totalPages - 2 && s++ : 7 <= this.totalPages && (7 === this.totalPages || this.options.pageNumber >= this.totalPages - 3) && s++, a = i; a <= s; a++) t.push(r.sprintf('<li class="page-item%s">', a === this.options.pageNumber ? ' active' : ''), '<a class="page-link" href="#">', a, '</a>', '</li>');
                        8 <= this.totalPages && this.options.pageNumber <= this.totalPages - 4 && t.push('<li class="page-item page-last-separator disabled">', '<a class="page-link" href="#">...</a>', '</li>'), 6 <= this.totalPages && this.options.pageNumber <= this.totalPages - 3 && t.push(r.sprintf('<li class="page-item page-last%s">', this.totalPages === this.options.pageNumber ? ' active' : ''), '<a class="page-link" href="#">', this.totalPages, '</a>', '</li>'), t.push(r.sprintf('<li class="page-item page-next"><a class="page-link" href="#">%s</a></li>', this.options.paginationNextText), '</ul>', '</div>')
                    }
                ...
                value: function (e, t) {
                    var o = this,
                        ...
                        p = {},
                        c = [];
                    if (!this.hiddenRows.includes(e)) {
                        if (s = r.calculateObjectValue(this.options, this.options.rowStyle, [e, t], s), s && s.css) {
                            var h = !0,
                                u = !1,
                                g = void 0;
                            try {
                                for (var f, b = Object.entries(s.css)[Symbol.iterator](); !(h = (f = b.next()).done); h = !0) {
                                    var m = f.value,
                                        w = i(m, 2),
                                        y = w[0],
                                        x = w[1];
                        ...
                        if (e._data && !n.isEmptyObject(e._data)) {
                            var I = !0,
                                ...
                                N = void 0;
                            try {
                                for (var V, j = Object.entries(e._data)[Symbol.iterator](); !(I = (V = j.next()).done); I = !0) {
                                    var B = V.value,
                                        L = i(B, 2),
                                        H = L[0],
                                        k = L[1];
                        ...
                        return a.push('<tr', r.sprintf(' %s', c.length ? c.join(' ') : void 0), r.sprintf(' id="%s"', Array.isArray(e) ? void 0 : e._id), r.sprintf(' class="%s"', s.classes || (Array.isArray(e) ? void 0 : e._class)), ' data-index="' + t + '"', r.sprintf(' data-uniqueid="%s"', e[this.options.uniqueId]), r.sprintf('%s', d), '>'), this.options.cardView && a.push('<td colspan="' + this.header.fields.length + '"><div class="card-views">'), !this.options.cardView && this.options.detailView && (a.push('<td>'), r.calculateObjectValue(null, this.options.detailFilter, [t, e]) && a.push('\n            <a class="detail-icon" href="#">\n            <i class="' + this.options.iconsPrefix + ' ' + this.options.icons.detailOpen + '"></i>\n            </a>\n          '), a.push('</td>')), this.header.fields.forEach(function (d, p) {
                            ...
                            if ((!o.fromHtml || 'undefined' != typeof u || $.checkbox || $.radio) && $.visible && (!o.options.cardView || $.cardVisible)) {
                                if ($.escape && (u = r.escapeHTML(u)), l.concat([o.header.styles[p]]).length && (y = ' style="' + l.concat([o.header.styles[p]]).join('; ') + '"'), e['_' + d + '_id'] && (m = r.sprintf(' id="%s"', e['_' + d + '_id'])), e['_' + d + '_class'] && (w = r.sprintf(' class="%s"', e['_' + d + '_class'])), e['_' + d + '_rowspan'] && (v = r.sprintf(' rowspan="%s"', e['_' + d + '_rowspan'])), e['_' + d + '_colspan'] && (x = r.sprintf(' colspan="%s"', e['_' + d + '_colspan'])), e['_' + d + '_title'] && (S = r.sprintf(' title="%s"', e['_' + d + '_title'])), b = r.calculateObjectValue(o.header, o.header.cellStyles[p], [u, e, t, d], b), b.classes && (w = ' class="' + b.classes + '"'), b.css) {
                                    var P = [],
                                        C = !0,
                                        T = !1,
                                        O = void 0;
                                    ...
                                    y = ' style="' + P.concat(o.header.styles[p]).join('; ') + '"'
                                }
                                if (g = r.calculateObjectValue($, o.header.formatters[p], [u, e, t, d], u), e['_' + d + '_data'] && !n.isEmptyObject(e['_' + d + '_data'])) {
                                    var V = !0,
                                        j = !1,
                                        B = void 0;
                                    try {
                                        for (var L, H = Object.entries(e['_' + d + '_data'])[Symbol.iterator](); !(V = (L = H.next()).done); V = !0) {
                                            var D = L.value,
                                                E = i(D, 2),
                                                z = E[0],
                                                U = E[1];
                                ...
                                if ($.checkbox || $.radio) {
                                    ...
                                    var M = o.options.showHeader ? '<span class="title"' + s + '>' + r.getFieldTitle(o.columns, d) + '</span>' : '';
                                    h = '<div class="card-view">' + M + '<span class="value">' + g + '</span></div>', o.options.smartDisplay && '' === g && (h = '<div class="card-view"></div>')
                                } else h = '<td' + m + w + y + k + v + x + S + '>' + g + '</td>';
                                a.push(h)
                            }
                ...
                value: function (e) {
                    ...
                    s ? this.$body.html(a) : this.$body.html('<tr class="no-records-found">' + r.sprintf('<td colspan="%s">%s</td>', this.$header.find('th').length, this.options.formatNoMatches()) + '</tr>'), e || this.scrollTo(0), this.$body.find('> tr[data-index] > td').off('click dblclick').on('click dblclick', function (e) {
                        ...
                        if (!s.find('.detail-icon').length && (t.trigger('click' === i ? 'click-cell' : 'dbl-click-cell', h, g, d, s), t.trigger('click' === i ? 'click-row' : 'dbl-click-row', d, l, h), 'click' === i && t.options.clickToSelect && u.clickToSelect && !t.options.ignoreClickToSelectOn(a))) {
                        ...
                        var e = n(i.currentTarget),
                            ...
                            s = a.data('index'),
                            l = o[s];
                        if (a.next().is('tr.detail-view')) e.find('i').attr('class', r.sprintf('%s %s', t.options.iconsPrefix, t.options.icons.detailOpen)), t.trigger('collapse-row', s, l, a.next()), a.next().remove();
                        else {
                            ...
                            if (-1 !== l) {
                                ...
                                var d = function (e, o) {
                                        t.$body.find('>tr:not(.no-records-found)').each(function (a, i) {
                                            var r = n(i),
                                                d = r.find(t.options.cardView ? '.card-view' : 'td').eq(l),
                                                p = e.indexOf(' '),
                                                c = e.substring(0, p),
                                                h = e.substring(p + 1);
                                    ...
                                    h = void 0;
                                try {
                                    for (var u, g = Object.entries(a)[Symbol.iterator](); !(p = (u = g.next()).done); p = !0) {
                                        var f = u.value,
                                            b = i(f, 2),
                                            m = b[0],
                                            w = b[1];
                ...
                value: function () {
                    ...
                    if (0 < i.length) {
                        var d = i.parents('th');
                        if (0 < d.length) {
                            var p = d.attr('data-field');
                            if (void 0 !== p) {
                                var c = this.$header.find('[data-field=\'' + p + '\']');
                                0 < c.length && c.find(':input').addClass('focus-temp')
                            }
                        }
                    }
                    ...
                    this.$body.find('>tr:first-child:not(.no-records-found) > *').each(function (t, o) {
                        var i = n(o),
                            a = t;
                        if (e.options.detailView && !e.options.cardView && (0 === t && e.$header_.find('th.detail').find('.fht-cell').width(i.innerWidth()), a = t - 1), -1 !== a) {
                            var d = e.$header_.find(r.sprintf('th[data-field="%s"]', s[a]));
                            1 < d.length && (d = n(l[i[0].cellIndex]));
                            var p = d.width() - d.find('.fht-cell').width();
                ...
                value: function () {
                    ...
                    if (this.options.showFooter && !this.options.cardView) {
                        ...
                        var o = !0,
                            ...
                            s = void 0;
                        try {
                            for (var l, d = this.columns[Symbol.iterator](); !(o = (l = d.next()).done); o = !0) {
                                var p = l.value,
                                    c = '',
                                    h = '',
                                    u = [],
                                ...
                                if (c = r.sprintf('text-align: %s; ', p.falign ? p.falign : p.align), h = r.sprintf('vertical-align: %s; ', p.valign), g = r.calculateObjectValue(null, this.options.footerStyle), g && g.css) {
                                    var b = !0,
                                        ...
                                        w = void 0;
                                    try {
                                        for (var y, k = Object.keys(g.css)[Symbol.iterator](); !(b = (y = k.next()).done); b = !0) {
                                            var v = y.value,
                                                x = i(v, 2),
                                                S = x[0],
                                                $ = x[1];
                        ...
                        this.$tableFooter.find('tr').html(t.join('')), this.$tableFooter.show(), clearTimeout(this.timeoutFooter_), this.timeoutFooter_ = setTimeout(n.proxy(this.fitFooter, this), this.$el.is(':hidden') ? 100 : 0)
                    }
                }
            }, {
                key: 'fitFooter',
                value: function () {
                    if (clearTimeout(this.timeoutFooter_), this.$el.is(':hidden')) return void(this.timeoutFooter_ = setTimeout(n.proxy(this.fitFooter, this), 100));
                ...
                value: function (e) {
                    var t = 0;
                    if (e && e.height && (this.options.height = e.height), this.$selectAll.prop('checked', 0 < this.$selectItem.length && this.$selectItem.length === this.$selectItem.filter(':checked').length), this.options.height) {
                ...
                value: function (e) {
                    var t = Array.isArray(e) ? e : [e],
                        ...
                        a = void 0;
                    try {
                        for (var s, l, r = t[Symbol.iterator](); !(o = (s = r.next()).done); o = !0)
                            if (l = s.value, l.hasOwnProperty('id') && l.hasOwnProperty('row')) {
                                var d = this.options.data.indexOf(this.getRowByUniqueId(l.id)); - 1 !== d && n.extend(this.options.data[d], l.row)
                            }
                    } catch (e) {
                        i = !0, a = e
                    } finally {
                ...
                value: function (e) {
                    var t = Array.isArray(e) ? e : [e],
                        ...
                        a = void 0;
                    try {
                        for (var s, l, r = t[Symbol.iterator](); !(o = (s = r.next()).done); o = !0)(l = s.value, l.hasOwnProperty('index') && l.hasOwnProperty('row')) && n.extend(this.options.data[l.index], l.row)
                    } catch (e) {
                        i = !0, a = e
                    } finally {
                        try {
                ...
                value: function (e, t) {
                    ...
                    if (e.hasOwnProperty('index') ? o = this.getData()[e.index] : e.hasOwnProperty('uniqueId') && (o = this.getRowByUniqueId(e.uniqueId)), !!o) {
                        var i = this.hiddenRows.indexOf(o);
                ...
                value: function (e) {
                    ...
                    if (e) {
                        ...
                        for (var d = this.$body.children(), p = 0; p < d.length; p++) this.expandRow_(!0, n(d[p]).data('index'))
                }
            }, {
                key: 'collapseAllRows',
                value: function (e) {
                    if (e) this.expandRow_(!1, 0);
                        ...
                        for (var t = this.$body.children(), o = 0; o < t.length; o++) this.expandRow_(!1, n(t[o]).data('index'))
                }
            }, {
